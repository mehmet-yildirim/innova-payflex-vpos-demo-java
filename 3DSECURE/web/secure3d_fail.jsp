...
<body>
<h1>3D Secure kart doğrulaması başarısız!</h1>
<table>
    <tr>
        <td colspan="2"><b>Başarısız Sonuç URL sayfasına dönülen POST verileri aşağıdadır.</b></td>
    </tr>
    ...
    <tr>
        <td></td>
        <td>
            3D Secure doğrulaması banka tarafından başarısızlıkla sonuçlandı. Detaylar için Payflex MPI ISD dokümanına
            göz atınız.
            <br>
